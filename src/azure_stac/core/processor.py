...
class BaseProcessor(metaclass=ABCMeta):
    ...
    def __clean_up(self) -> None:
        ...
        temp_folder_path = os.path.join(self.WORKING_DIR,
    ...
    def __configure_metrics(self, metric_types: any = None):
        ...
        if metric_types is not None:
            ...
            metrics_client = [ MetricsFactory.get_metrics_provider(type) for type in metric_types ]
    ...
    def begin_listening(self):
        ...
        with ServiceBusClient.from_connection_string(conn_str=self.SERVICE_BUS_CONNECTION_STRING, 
                                                retry_total=1, 
