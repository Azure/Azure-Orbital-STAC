...
helm install stac-scaler ${PRJ_ROOT}/deploy/helm/stac-scaler \
    ...
    --set processors.staccollection.env.SUBSCRIPTION_NAME=${STACCOLLECTION_SERVICE_BUS_SUBSCRIPTION_NAME} \
    ...
    --set processors.staceventconsumer.env.TOPIC_NAME=${PGSTAC_SERVICE_BUS_TOPIC_NAME} \
    --set processors.staceventconsumer.env.SUBSCRIPTION_NAME=${PGSTAC_SERVICE_BUS_SUBSCRIPTION_NAME} \
    ...
    --set processors.generatestacjson.env.TOPIC_NAME=${STACIFY_SERVICE_BUS_TOPIC_NAME} \
    --set processors.generatestacjson.env.SUBSCRIPTION_NAME=${STACIFY_SERVICE_BUS_SUBSCRIPTION_NAME} \
